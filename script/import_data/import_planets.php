...
$conn->exec("DELETE FROM travia_day_name");
$conn->exec("DELETE FROM travia_trips");
$conn->exec("DELETE FROM travia_planet");
$conn->exec("DELETE FROM travia_sun");
$conn->exec("DELETE FROM travia_sector");
$conn->exec("DELETE FROM travia_region");
